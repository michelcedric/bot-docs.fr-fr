...
L’[outil LUISGen](https://github.com/Microsoft/botbuilder-tools/tree/master/LUISGen) permet de générer des classes qui facilitent l’extraction d’entités de LUIS dans le code de votre robot.
